...
Problemas_arquivo = "Site\Site_Flask\Problemas.json"
Respostas_arquivo = "Site\Site_Flask\Respostas.json"
...
def chamarNLP(fraseDoUsuario:str):
    with open(Problemas_arquivo, 'r', encoding='utf-8') as arquivo:
    ...
    Respostas = json.load(open(Respostas_arquivo, 'r', encoding='utf-8'))
